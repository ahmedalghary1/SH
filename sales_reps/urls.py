...
urlpatterns = [
    ...
    path('assignments/<int:pk>/delete/', views.SalesRepStockAssignmentDeleteView.as_view(), name='assignment_delete'),
    ...
    path('collections/<int:pk>/delete/', views.SalesRepCollectionDeleteView.as_view(), name='collection_delete'),
